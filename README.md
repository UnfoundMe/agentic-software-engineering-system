...
> **Status: Phase 0 — scaffold.** Structure, infrastructure and architecture are
> in place. No behaviour is implemented yet.
...
| **URL Shortener** | [`src/url-shortener/`](src/url-shortener/) | **Generated by the orchestrator** (.NET 9) |
...
Requires **Docker**, **uv**, and **.NET 9 SDK** (for the generated workload).
